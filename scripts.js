...
let secaoVantagems = '<ul id="secao-vantagens"> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805453/hmed/Cart%C3%A3o_de_cr%C3%A9dito.png" alt="3 vezes sem juros ou até 12 vezes."> <div> <strong class="cor-principal"> 3x sem juros </strong> <br> ou até 12x </div> </li> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805454/hmed/Boleto_e_Pix.png" alt="boleto ou pix com 3% de desconto"> <div> <span class="uppercase"> boleto ou pix </span> <br> <strong class="cor-principal"> 3% de desconto </strong> </div> </li> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805450/hmed/Mapa_do_Brasil.png" alt="envio para todo o brasil"> <div> envio para <br> <strong class="cor-principal">todo o brasil</strong> <br> </div> </li> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805451/hmed/Frete_gr%C3%A1tis.png" alt=""> <div> <strong class="cor-principal">frente grátis</strong> <br> acima de R$750,00 </div> </li> </ul>';
...
function aplicaEstilos() {
  body.append("<style> .uppercase { text-transform: uppercase; } /** HOMEPAGE BUSCA **/ .busca.borda-alpha { background: #fff; border: none; } .busca input { width: 90%; } .busca .botao-busca { right: -21px; } /** HOMEPAGE CARRINHO **/ .carrinho.vazio>a span { line-height: 30px; font-weight: 100; text-transform: uppercase; } .carrinho>a i { width: 30px; height: 30px; line-height: 33px; font-size: 18px; } /** MENU **/ #novo-menu { display: grid; grid-template-columns: repeat(5, 1fr); text-align: center; align-items: center; row-gap: 0.4rem; margin: 2rem 0; } #novo-menu a { font-size: 1.4em; font-family: 'open sans' ,sans-serif; color: #5d616d; min-height:40px; align-self: baseline; } #novo-menu a:hover { color: #2b5263; font-weight: 500; } #novo-menu a:first-child { text-transform:uppercase; } #novo-menu a div.pontinho-menu { height: 7px; width: 7px; background-color: #bbb; border-radius: 50%; display: inline-block; margin-bottom: 2px; margin-right: 3px; } /** CORPO DA PAGINA && LISTAGEM DE PRODUTOS **/ body.pagina-inicial #corpo .coluna.esquerda { display: none; } .listagem .titulo-categoria { font-size: 2em; padding: 0; } .listagem .titulo-categoria:hover { background: transparent; } .listagem .produtos-carrossel .listagem-linha li .listagem-item:hover { border: 1px solid #cccc; box-shadow: 0px 0px 10px -3px rgb(0 0 0 / 40%); } .listagem .listagem-item:hover .acoes-produto { position: relative; } .listagem .listagem-item .nome-produto { font-weight:bold; } .listagem .produtos-carrossel .listagem-linha li .listagem-item { padding-bottom: 3rem; } .listagem-item:hover .botao.principal.botao-comprar { background-color: #2B5263; width: 80%; font-weight: bold; padding: 8px; font-size: 1.3em; } /** SECAO VANTAGENS **/ #secao-vantagens { display: flex; width: 100%; justify-content: space-around; font-size: 1.5em; margin-bottom:2rem; } #secao-vantagens li { display: flex; justify-content: center; align-items: center; } #secao-vantagens img { max-width: 80px; margin-right: 5px; } #secao-vantagens strong { text-transform: uppercase; } /** PAGINA DE CATEGORIA (MENU LATERAL) **/ #corpo .breadcrumbs ul li * { font-size: 1.3em; padding: 0 10px; } #corpo .menu.lateral .nivel-um>li.borda-principal>a { padding: 0 20px; background-color: #254756; } #corpo .menu.lateral li>a i { display: none!important; } #corpo .menu.lateral .nivel-um>li.borda-principal>a strong { color: #fff } #corpo .menu.lateral .filtro h4 { margin-top: 0; overflow: hidden; padding-bottom: 10px; border-bottom: 1px solid rgba(0,0,0,0.1); color: white; padding: 10px 10px; font-size: 1.4em; font-weight: bold; } #corpot .menu.lateral .filtro .borda-alpha { background: white; } /** NOVO RODAPE **/ #novoRodape { width: 100%; display: flex; } #novoRodape .container-esquerda { width: 35%; display: flex; flex-direction: column; justify-content: center; align-items: center; } #novoRodape .container-esquerda .logo-container img { max-width: 150px; } #novoRodape .container-direita { display:flex; width: 65%; } #novoRodape .container-direita .categorias-container, #novoRodape .container-direita .conteudo-pagamento-selos-container { display: flex; flex-direction: column; align-items: start; padding: 1.5rem; } #novoRodape .container-direita .selos-container { display: flex; } #novoRodape .container-direita .selos-container ul { display: flex; width: 100%; justify-content: center; align-items: center; } #novoRodape .container-direita .selos-container ul li { margin: 1rem; } /** RESPONSIVIDADE MOBILE < 900PX **/ @media all and (max-width:900px) { #novo-menu { display: block; text-align: left; margin: 2rem 1rem; } #novo-menu a { font-size: 1.2em; } #novo-menu a~a { border-top: 1px solid #888; padding-top: 10px; margin-top: 10px; } #cabecalho .menu.superior { background-color: transparent; border: 1px solid #888; border-radius: 10px; margin: 1rem 0rem; } .conteudo-topo .busca-mobile { background-color: #fff; } .conteudo-topo .busca-mobile .atalho-menu { background: url(https://res.cloudinary.com/tesseract/image/upload/v1628805448/hmed/Menu_mobile.png) no-repeat; background-size: 80%; border: 0; height: 32px; width: 25px; } .busca .botao-busca { height: auto; top: 0; right: 30px; line-height: 28px; background-color: #2B5263; } .busca input { width: 70%; } .conteiner .logo { display:none; } /** BANNER / SLIDES **/ .flexslider .slides img { height: 230px; width: auto; object-fit: cover; } #secao-vantagens { display: grid; grid-template-columns: 1fr 1fr; font-size: 0.9em; margin-bottom: 2rem; margin-left: 0px; } #secao-vantagens li { display: flex; justify-content: center; align-items: center; padding: 5px 0px; } #secao-vantagens img { max-width: 45px; margin-right: 5px; } .listagem .titulo-categoria { text-align:center; font-size:1.5em; display: flex; justify-content: center; } .listagem .titulo-categoria strong:after { content: '.'; display: block; height: 5px; width: 70%; margin: 0px auto; text-indent: -9999px; border-bottom: 2px solid #999; } .listagem .listagem-item .nome-produto { font-weight:bold; } .listagem-item .botao.principal.botao-comprar { background-color: #2B5263; padding: 8px 0px; width: 100%; text-align: center; border-radius: 10px; } .acoes-produto-responsiva.visible-phone { position: relative; margin-top: 1rem!important; width: 100%; text-align: center; } .acoes-produto-responsiva.visible-phone a { width: 80%; text-align: center; border-radius: 10px; padding: 5px; } .acoes-produto-responsiva.visible-phone a span.titulo { font-weight: bold; text-transform: uppercase; } .info-produto { text-align: center; font-size: 1.3em; } .bandeiras-produto span.fundo-principal.bandeira-promocao { font-size: 1.1em; padding: 3px 20px; border: none; } } </style");
}
