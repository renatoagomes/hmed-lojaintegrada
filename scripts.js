$(function () {
  ...
  let linksMenu = $('#cabecalho .menu.superior li:not(.categoria-marcas) ul.nivel-dois > li > a');
  let coresCategorias = {
  ...
  function ajustaNovoMenu() {
    ...
    linksMenu.each(function (idx, el) {
      console.log("ajustaNovoMenu: " +el.innerText);
      let corCategoria = getCorCategoria(el.innerText);

      if (el.innerText.match('Hemostático Cirúrgico')) {
        $(el).html('<div class="pontinho-menu quadrado" style="background-color:'+corCategoria+'"></div>'+el.innerText);
        ultimos.push(el);
      }
      else {
    ...
    for (let ultimoMenu in ultimos) {
      novoMenu.append(ultimos[ultimoMenu]);
    }
  ...
  function insereSecaoVantagens(){
    let secaoVantagems = ' <ul id="secao-vantagens"> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805453/hmed/Cart%C3%A3o_de_cr%C3%A9dito.png" alt="até 12 vezes."> <div class="cor-principal"><strong>Em até 12x </strong> <br>no cartão de crédito</div> </li> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805454/hmed/Boleto_e_Pix.png" alt="boleto ou pix com 4% de desconto"> <div class="cor-principal"> <span class="uppercase"> boleto ou pix </span> <br> <strong> 4% de desconto </strong> </div> </li> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805450/hmed/Mapa_do_Brasil.png" alt="envio para todo o brasil"> <div class="cor-principal"> Envio para <br> <strong>todo o brasil</strong> <br> </div> </li> <li> <img src="https://res.cloudinary.com/tesseract/image/upload/v1628805451/hmed/Frete_gr%C3%A1tis.png" alt=""> <div class="cor-principal"> <strong>frete grátis</strong> <br> acima de R$750,00 </div> </li> </ul> ';
